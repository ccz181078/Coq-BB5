...
Definition St_list:= St0::St1::St2::St3::nil.
...
| (St1,Σ0)::t => (listStΣ_enc t)~0~1~0
| (St1,Σ1)::t => (listStΣ_enc t)~1~1~0
| (St2,Σ0)::t => (listStΣ_enc t)~0~0~1
| (St2,Σ1)::t => (listStΣ_enc t)~1~0~1
| (St3,Σ0)::t => (listStΣ_enc t)~0~1~1
| (St3,Σ1)::t => (listStΣ_enc t)~1~1~1
end.
...
Definition decider2 := (loop1_decider 107 (1::2::4::8::16::32::64::128::256::512::nil)).
...
Definition decider15 := (NGramCPS_LRU_decider 2 2 10000).
Definition decider16 := (NGramCPS_decider_impl1 10 4 4 10000).
...
Definition TM_to_N(tm:TM Σ):N :=
  ...
  (option_Trans_to_N (tm St3 Σ1))++nil
  ) 0.
...
Definition decider17 := (RepWL_ES_decider 4 3 320 10000).
...
Definition q_suc:SearchQueue->SearchQueue := (fun x => SearchQueue_upds x decider_all 13).
