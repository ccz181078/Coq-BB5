...
Definition root4_nontrivial_4 := nth 5 (fst q_1_manual) root.

Definition q_0 := SearchQueue_init root4_nontrivial_4.
...
Lemma q_200_WF:
  SearchQueue_WF (N.to_nat BB5_minus_one) q_200 root4_nontrivial_4.
Proof.
  rewrite q_200_spec.
  apply q_200_WF_gen.
  red. repeat split.
...
Lemma root4_nontrivial_4_HTUB:
  TNF_Node_HTUB (N.to_nat BB5_minus_one) root4_nontrivial_4.
Proof.
