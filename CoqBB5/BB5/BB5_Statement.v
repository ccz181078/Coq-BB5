(** 
  This files contains the theorem statement of "BB(5) = 47,176,870" as well as the definitions needed for the statement.
  The statement (see `BB5_value_statement`) and the definitions are quite transparent, the only prerequisite is to know what Turing machine are.
*)

Require Import ZArith.

(** 5-state Turing machines *)
Inductive St:Set :=
| St0
| St1
| St2
