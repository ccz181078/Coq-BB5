...
Compiling the BB5 proof takes about 45 minutes on 13 cores (Apple silicon) and using Coq's `native_compute` (see above). Without `native_compute`, still on 13 cores, takes about 3 hours.
