...
We recommend installing `coq-native` before compiling the proof as it compiles about three times faster (this currently requires using OCaml 4 instead of newer versions, e.g. `opam switch 4.14.2`):
