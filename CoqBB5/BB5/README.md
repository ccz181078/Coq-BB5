...
We compile BusyCoq first (see `../../BusyCoq`) in order to get the proofs for 12 out the 13 [Sporadic Machines](#sporadic-machines) and takes about 8 minutes on 13 cores (Apple silicon).
