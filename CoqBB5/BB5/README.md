...
This is a Coq project for proving BB(5)=47,176,870. This result is proved in `BB52Theorem.v`. The basic definitions for this theorem are in `BB5_Statement.v`.
