...
Lemma root_q_WF:
  SearchQueue_WF (N.to_nat BB3_minus_one) root_q root.
Proof.
  apply SearchQueue_init_spec,root_WF.
Qed.

Lemma root_q_upd1_WF:
  SearchQueue_WF (N.to_nat BB3_minus_one) root_q_upd1 root.
Proof.
...
Lemma root_q_upd1_simplified_WF:
  SearchQueue_WF (N.to_nat BB3_minus_one) root_q_upd1_simplified root.
Proof.
...
Lemma q_200_WF:
  SearchQueue_WF (N.to_nat BB3_minus_one) q_200 root.
Proof.
  rewrite q_200_spec.
  generalize 200.
  intro n.
...
Lemma root_HTUB:
  TNF_Node_HTUB (N.to_nat BB3_minus_one) root.
Proof.
...
Lemma TM0_HTUB:
  HaltTimeUpperBound Σ (N.to_nat BB3_minus_one) (InitES Σ Σ0) (LE Σ (TM0)).
Proof.
  apply root_HTUB.
Qed.

Lemma allTM_HTUB:
  HaltTimeUpperBound Σ (N.to_nat BB3_minus_one) (InitES Σ Σ0) (fun _ => True).
Proof.
