...
printf "%s" "$(< BB3_verified_enumeration.csv)" > tmp
mv tmp BB3_verified_enumeration.csv
...
EXPECTED_HASH=ed8285a50cde827a560ddba9d0e0ff4f7d308a78eee9c13aa5cc9023fc021f27
# Compare the hashes
