...
From CoqBB2x3 Require Import List_Tape.
...
From CoqBB2x3 Require Import Deciders_Common.
From CoqBB2x3 Require Import Decider_Halt.
From CoqBB2x3 Require Import Decider_Loop.
From CoqBB2x3 Require Import Decider_NGramCPS.
From CoqBB2x3 Require Import Decider_RepWL.

Set Warnings "-abstract-large-number".

(* Definition decider0 := HaltDecider_nil.
Definition decider1 := halt_decider 130. *)
Definition decider2 := ((loop1_decider 38),LOOP1_params_38).
...
Definition decider8 := ((RepWL_ES_decider 2 3 320 400),REPWL_params_2_3_320_400).
...
Lemma decider2_WF: HaltDecider_WF (N.to_nat BB2x3_minus_one) (fst decider2).
Proof.
  apply loop1_decider_WF.
  unfold BB2x3_minus_one.
  lia.
Qed.

Lemma decider_all_spec: HaltDeciderWithIdentifier_WF (N.to_nat BB2x3_minus_one) decider_all.
Proof.
