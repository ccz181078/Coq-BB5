(** 
  This files contains the theorem statement of "BB(2,4) = 3,932,964" as well as the definitions needed for the statement.
  The statement (see `BB2x4_value_statement`) and the definitions are quite transparent, the only prerequisite is to know what Turing machine are.
*)
...
Definition BB2x4_value_statement :=
  (forall tm n0, HaltsAtPlusOne Σ tm n0 (InitES Σ Σ0) -> n0 <= N.to_nat BB2x4) /\
  (exists tm, HaltsAtPlusOne Σ tm (N.to_nat BB2x4) (InitES Σ Σ0)).