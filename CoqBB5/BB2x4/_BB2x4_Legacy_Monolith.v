...
Definition BB24_champion := (makeTM BR1 AL2 AR1 AR1 BL1 AL1 BR3 HR1).

Lemma BB24_lower_bound:
  exists tm,
  HaltsAt _ tm (N.to_nat BB) (InitES Σ Σ0).
Proof.
  exists BB24_champion.
...
Proof.
  ...
  - intros tm n0.
    apply allTM_HTUB.
    trivial.
  - apply BB24_lower_bound.
Qed.

Print Assumptions BB24_value.
End MacroMachine.
